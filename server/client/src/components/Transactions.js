  ...
  return (
    <>
      ...
      <div className="h-[900px] lg:w-[80%] w-[90%] flex flex-col items-end">
        <div
          className="flex flex-col lg:flex-row justify-center items-start lg:items-center w-[100%] lg:w-[100%] pb-4 mb-2 lg:mb-10 lg:border-b-[1px] lg:border-t-0 border-gray-300"
          data-aos="fade-up"
          data-aos-duration="1000"
        >
          <h1 className="text-gray-600 text-[30px] lg:text-[35px] font-semibold w-[100%] lg:w-[30%]">
            Your Transactions
          </h1>
          <div className="flex flex-col lg:flex-row justify-end items-start lg:items-center w-[100%] lg:w-[70%] lg:pr-4 border-y-[1px] lg:border-y-0 border-gray-300 mt-10 lg:mt-0 pt-4 lg:pt-0">
            <p className="text-gray-600 text-[20px] lg:text-[22px] font-bold lg:mr-8 mb-4 lg:mb-0 lg:w-[20%]">
              Filter by:{" "}
            </p>
            <p className="text-gray-600 text-[15px] lg:text-[15px] font-bold lg:mr-4">
              Date:{" "}
            </p>
            <input
              type="date"
              className="mb-4 lg:mb-0 lg:mr-6 h-10 w-64 focus:outline-0 hover:border-2 hover:border-red-400 p-2 text-sm mt-1 cursor-pointer bg-gray-100 rounded-md"
              onChange={(e) => {
              ...
              value={filters.date}
            ></input>
            <p className="text-gray-600 text-[15px] lg:text-[15px] font-bold mr-4">
              Category:{" "}
            </p>
            <select
              required
              className="block h-10 w-64 focus:outline-0 hover:border-2 hover:border-red-400 p-2 text-sm mt-1 cursor-pointer bg-gray-100 rounded-md mb-4 lg:mb-0"
            ...
            <button
              ...
              className="btn-violet w-[140px] lg:w-[170px] h-[40px] lg:h-[40px] mb-4 lg:mb-0 lg:ml-4"
            >
        ...
        <button
          ...
          className="btn-green w-[180px] h-[90px] lg:h-[50px] mb-2"
          data-aos="fade-up"
          data-aos-duration="1000"
        >
